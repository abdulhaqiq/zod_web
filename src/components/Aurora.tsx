...
export default function Aurora({
  ...
  useEffect(() => {
    ...
    const stopsToArrays = (stops: [string, string, string]) =>
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColorStops: { value: stopsToArrays(colorStops) },
    ...
    const tick = (t: number) => {
      ...
      program.uniforms.uColorStops.value = stopsToArrays(p.colorStops ?? colorStops);
